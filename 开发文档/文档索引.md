...
本开发文档分为三个部分，全面覆盖了AIJian项目的技术架构、实现细节和开发指南。
...
### 文档链接
- [Part 1 - 架构与前端](AIJian_完整开发文档.md)
- [Part 2 - 数据库与AI](AIJian_完整开发文档_Part2.md)
- [Part 3 - 服务与部署](AIJian_完整开发文档_Part3.md)
...
本文档基于 **AIJian v2.0** 项目实际代码分析编写，包含：
